...
function getsetup_viz_d3_state_heatmap()
{
  $options['_CREDITS']				= 'Main Developters: Gregory Moon, Rahul Salla.';
  ...
  $options[30]['description']			= 'Width of the heatmap';
  $options[30]['detail']				= 'Width of the heatmap.';
  ...
  $options[510]['name']				= 'minColor';
  $options[510]['description']			= 'Please select the minimum color for the heatmap.';
  $options[510]['detail']				= 'This sets the lightest color for a value on the heatmap.';
  $options[510]['type']				= 'Color';
  $options[510]['link']				= 'link to further information..?';
  $options[510]['lookup']				= ''; #this would be if i have a dropdown and want to lookup the value you would enter a sql script with the column that comes back being the selection
  $options[510]['default']				= '';
  ...
  $options[420]['name']				= 'maxColor';
  $options[420]['description']			= 'Please select the maximum color for the heatmap.';
  $options[420]['detail']				= 'This sets the darkest color for a value on the heatmap.';
  $options[420]['type']				= 'Color';
  $options[420]['link']				= 'link to further information..?';
  $options[420]['lookup']				= ''; #this would be if i have a dropdown and want to lookup the value you would enter a sql script with the column that comes back being the selection
  $options[420]['default']				= '';
  $options[420]['optional']			= 'no';
  $options[420]['repeatable']			= 'no';
  $options[420]['perdashboard']		= 'yes';
  $options[420]['dependenton']			= '';

  $options[600]['name']				= 'selectcolor';
  $options[600]['description']			= 'Please select the color of the selected state.';
  $options[600]['detail']				= '';
  $options[600]['type']				= 'Color';
  $options[600]['link']				= 'link to further information..?';
  $options[600]['lookup']				= ''; #this would be if i have a dropdown and want to lookup the value you would enter a sql script with the column that comes back being the selection
  $options[600]['default']				= '551A8B';
  $options[600]['optional']			= 'no';
  $options[600]['repeatable']			= 'no';
  $options[600]['perdashboard']		= 'yes';
  ...
  $options[800]['name']				= 'stateLabelTextColor';
  $options[800]['description']		= 'Color of the font of the state labels.';
  $options[800]['detail']				= '';
  $options[800]['type']				= 'Color';
  $options[800]['link']				= 'link to further information..?';
  $options[800]['lookup']				= ''; 
  $options[800]['default']			= '000000';
  $options[800]['optional']			= 'no';
  $options[800]['repeatable']			= 'no';
  $options[800]['perdashboard']		= 'yes';
  $options[800]['dependenton']		= '';

  $options[810]['name']				= 'stateLabelFontSize';
  $options[810]['description']		= 'Size of font of state labels.';
  $options[810]['detail']				= '';
  $options[810]['type']				= 'Integer';
  $options[810]['link']				= 'link to further information..?';
  $options[810]['lookup']				= ''; 
  $options[810]['default']			= '20';
  $options[810]['optional']			= 'no';
  $options[810]['repeatable']			= 'no';
  $options[810]['perdashboard']		= 'yes';
  $options[810]['dependenton']		= '';

  $options[820]['name']				= 'stateLabelFontName';
  $options[820]['description']		= 'Font of state labels.';
  $options[820]['detail']				= '';
  $options[820]['type']				= 'Text';
  $options[820]['link']				= 'link to further information..?';
  $options[820]['lookup']				= ''; 
  $options[820]['default']			= 'Verdana';
  $options[820]['optional']			= 'no';
  $options[820]['repeatable']			= 'no';
  $options[820]['perdashboard']		= 'yes';
  $options[820]['dependenton']		= '';

  $options[700]['name']				= 'activeStateTextColor';
  $options[700]['description']		= 'Color of the font of the selected state.';
  $options[700]['detail']				= '';
  $options[700]['type']				= 'Color';
  $options[700]['link']				= 'link to further information..?';
  $options[700]['lookup']				= ''; 
  $options[700]['default']			= '000000';
  $options[700]['optional']			= 'no';
  $options[700]['repeatable']			= 'no';
  $options[700]['perdashboard']		= 'yes';
  $options[700]['dependenton']		= '';

  $options[710]['name']				= 'activeStateFontSize';
  $options[710]['description']		= 'Size of font of selected state.';
  $options[710]['detail']				= '';
  $options[710]['type']				= 'Integer';
  $options[710]['link']				= 'link to further information..?';
  $options[710]['lookup']				= ''; 
  $options[710]['default']			= '20';
  $options[710]['optional']			= 'no';
  $options[710]['repeatable']			= 'no';
  $options[710]['perdashboard']		= 'yes';
  $options[710]['dependenton']		= '';

  $options[720]['name']				= 'activeStateFontName';
  $options[720]['description']		= 'Font of selected state.';
  $options[720]['detail']				= '';
  $options[720]['type']				= 'Text';
  $options[720]['link']				= 'link to further information..?';
  $options[720]['lookup']				= ''; 
  $options[720]['default']			= 'Verdana';
  $options[720]['optional']			= 'no';
  $options[720]['repeatable']			= 'no';
  $options[720]['perdashboard']		= 'yes';
  $options[720]['dependenton']		= '';

  $options[730]['name']				= 'activeStateFontWeight';
  $options[730]['description']		= 'Font weight of selected state.';
  $options[730]['detail']				= '';
  $options[730]['type']				= 'Dropdown';
  $options[730]['link']				= 'link to further information..?';
  $options[730]['lookup']     = 'normal|bold|bolder|lighter|initial|inherit'; 
  $options[730]['default']			= 'bold';
  $options[730]['optional']			= 'no';
  $options[730]['repeatable']			= 'no';
  $options[730]['perdashboard']		= 'yes';
  $options[730]['dependenton']		= '';
  
  $options[740]['name']				= 'activeStateFontOutlineWidth';
  $options[740]['description']		= 'Width of outline of selected state text.';
  $options[740]['detail']				= '';
  $options[740]['type']				= 'Integer';
  $options[740]['link']				= 'link to further information..?';
  $options[740]['lookup']     = ''; 
  $options[740]['default']			= '1';
  $options[740]['optional']			= 'no';
  $options[740]['repeatable']			= 'no';
  $options[740]['perdashboard']		= 'yes';
  $options[740]['dependenton']		= '';

  $options[750]['name']				= 'activeStateFontOutlineColor';
  $options[750]['description']		= 'Color of outline of selected state text.';
  $options[750]['detail']				= '';
  $options[750]['type']				= 'Color';
  $options[750]['link']				= 'link to further information..?';
  $options[750]['lookup']     = ''; 
  $options[750]['default']			= '000000';
  $options[750]['optional']			= 'no';
  $options[750]['repeatable']			= 'no';
  $options[750]['perdashboard']		= 'yes';
  $options[750]['dependenton']		= '';

  $options[760]['name']				= 'stateOutlineWidth';
  $options[760]['description']		= 'Width of state outlines.';
  $options[760]['detail']				= '';
  $options[760]['type']				= 'Integer';
  $options[760]['link']				= 'link to further information..?';
  $options[760]['lookup']     = ''; 
  $options[760]['default']			= '1';
  $options[760]['optional']			= 'no';
  $options[760]['repeatable']			= 'no';
  $options[760]['perdashboard']		= 'yes';
  $options[760]['dependenton']		= '';

  $options[770]['name']				= 'stateOutlineColor';
  $options[770]['description']		= 'Color of state outlines.';
  $options[770]['detail']				= '';
  $options[770]['type']				= 'Color';
  $options[770]['link']				= 'link to further information..?';
  $options[770]['lookup']     = ''; 
  $options[770]['default']			= '000000';
  $options[770]['optional']			= 'no';
  $options[770]['repeatable']			= 'no';
  $options[770]['perdashboard']		= 'yes';
  $options[770]['dependenton']		= '';

  $options[780]['name']				= 'includeLegend';
  $options[780]['description']		= 'Include a legend with the heatmap?';
  $options[780]['detail']				= '';
  $options[780]['type']				= 'Dropdown';
  $options[780]['link']				= 'link to further information..?';
  $options[780]['lookup']     = 'yes|no'; 
  $options[780]['default']			= 'yes';
  $options[780]['optional']			= 'no';
  $options[780]['repeatable']			= 'no';
  $options[780]['perdashboard']		= 'yes';
  $options[780]['dependenton']		= '';

  $options[790]['name']				= 'numSteps';
  $options[790]['description']		= 'Number of steps in the legend.';
  $options[790]['detail']				= '';
  $options[790]['type']				= 'Integer';
  $options[790]['link']				= 'link to further information..?';
  $options[790]['lookup']     = ''; 
  $options[790]['default']			= '10';
  $options[790]['optional']			= 'no';
  $options[790]['repeatable']			= 'no';
  $options[790]['perdashboard']		= 'yes';
  $options[790]['dependenton']		= '';

  $options[900]['name']				= 'legendLabelFontSize';
  $options[900]['description']		= 'Legend Label font size';
  $options[900]['detail']				= '';
  $options[900]['type']				= 'Integer';
  $options[900]['link']				= 'link to further information..?';
  $options[900]['lookup']				= ''; 
  $options[900]['default']			= '20';
  $options[900]['optional']			= 'no';
  $options[900]['repeatable']			= 'no';
  $options[900]['perdashboard']		= 'yes';
  $options[900]['dependenton']		= '';

  $options[910]['name']				= 'legendLabelColor';
  $options[910]['description']		= 'Color of the legend labels.';
  $options[910]['detail']				= '';
  $options[910]['type']				= 'Color';
  $options[910]['link']				= 'link to further information..?';
  $options[910]['lookup']     = ''; 
  $options[910]['default']			= '000000';
  $options[910]['optional']			= 'no';
  $options[910]['repeatable']			= 'no';
  $options[910]['perdashboard']		= 'yes';
  $options[910]['dependenton']		= '';

  $options[920]['name']				= 'selectedStateLegendLabelColor';
  $options[920]['description']		= 'Color of the label indicating the selected state in the legend.';
  $options[920]['detail']				= '';
  $options[920]['type']				= 'Color';
  $options[920]['link']				= 'link to further information..?';
  $options[920]['lookup']     = ''; 
  $options[920]['default']			= '000000';
  $options[920]['optional']			= 'no';
  $options[920]['repeatable']			= 'no';
  $options[920]['perdashboard']		= 'yes';
  $options[920]['dependenton']		= '';

  $options[930]['name']				= 'legendLabelFontWeight';
  $options[930]['description']		= 'Font weight of selected state.';
  $options[930]['detail']				= '';
  $options[930]['type']				= 'Dropdown';
  $options[930]['link']				= 'link to further information..?';
  $options[930]['lookup']     = 'normal|bold|bolder|lighter|initial|inherit'; 
  $options[930]['default']			= 'bold';
  $options[930]['optional']			= 'no';
  $options[930]['repeatable']			= 'no';
  $options[930]['perdashboard']		= 'yes';
  $options[930]['dependenton']		= '';

  $options[940]['name']				= 'stateSelectionModule';
  $options[940]['description']		= 'What is the name of the input module that controls state selection?';
  $options[940]['detail']				= '';
  $options[940]['type']				= 'Text';
  $options[940]['link']				= 'link to further information..?';
  $options[940]['lookup']     = ''; 
  $options[940]['default']			= 'StateSelect';
  $options[940]['optional']			= 'no';
  $options[940]['repeatable']			= 'no';
  $options[940]['perdashboard']		= 'no';
  $options[940]['dependenton']		= '';

  return($options);
}

function place_viz_d3_state_heatmap($sid, $value, $options, $setup)	
{
  //General Options
  $title_text = $options["titleText"];

  //Dashboard Options
  $do = $options["dashboard_options"];
  $include_legend = $do["includeLegend"] == "yes";
  
  $ret_val = "	
    ".viz_d3_state_heatmap_persistent_js($sid, $options)."
    <div id='celement$sid'>
      <div id='element$sid'>
	<h1 id='element$sid-title'>$title_text</h1>
	<div id='element$sid-container'>
	  <svg id='element$sid-svg'>
	  </svg>
  ";

  if($include_legend){
    $ret_val .= "
      <svg id='element$sid-legend-svg'>
	<g id='element$sid-legend-group'>
	</g>
      </svg>
      <script>legend".$sid."gradient();</script>
    ";
  }
  ...
  $ret_val .= "
    ...
    ".viz_d3_state_heatmap_add_styles($sid, $options)."
    ".reload_viz_d3_state_heatmap($sid, $value, $options, $setup)."
  ";
...
function viz_d3_state_heatmap_js_init_vars($sid)
{
  return "
    var stateMetrics$sid, json$sid, width$sid, height$sid, centered$sid, projection$sid, path$sid, svg$sid,
      g$sid, currentlySelectedState$sid = null, fromReload$sid = false;
  ";
}

function viz_d3_state_heatmap_update_js_vars($sid, $options)
{
  global $db;

  //Options
  $tablename = $options["tablename"];
  $module_name = $options["stateSelectionModule"];

  //Dashboard Options
  $do = $options["dashboard_options"];
  $height = str_replace("px", "", $do["height"]);
  $width = str_replace("px", "", $do["width"]);

  //DB Access
  $state_metrics_query = "select * from $tablename";
  $state_metrics_result = $db->query($state_metrics_query);
  $state_metrics = $state_metrics_result->fetchAll();

  $module_sid = $db->fetchAll("select sid from station_variables where value='$module_name' and name='name'"); 
  $module_sid = $module_sid[0]["sid"];

  $selected_state_id = $db->fetchAll("select value from station_variables where sid='$module_sid' and name='value'"); 
  $selected_state_id = $selected_state_id[0]["value"];
  $selected_state = $db->fetchAll("select abbr from states where id='".$selected_state_id."'");
  $selected_state = $selected_state[0]["abbr"];

  
  return "
    stateMetrics$sid = {".js_state_metrics($state_metrics)."};
    json$sid = ".viz_d3_state_heatmap_js_states_json()."
    width$sid = $width;
    height$sid = $height;
    projection$sid = d3.geo.albersUsa().scale(width$sid).translate([0, 0]);
    path$sid = d3.geo.path().projection(projection$sid);
    currentlySelectedState$sid = {id:'".$selected_state."'};
  ";
}

function reload_viz_d3_state_heatmap($sid, $value, $options, $setup)
{
  //Dashboard Options
  $do = $options["dashboard_options"];
  $include_legend = $do["includeLegend"] == "yes";
  ...
  $ret_val = "
      <script>
	".viz_d3_state_heatmap_update_js_vars($sid, $options)."
	drawHeatmap$sid();
	clickHeatmap$sid(currentlySelectedState$sid);
  ";

  if($include_legend){
    $ret_val .= "legend".$sid."labels();";
  }
...
function viz_d3_state_heatmap_persistent_js($sid, $options){
  return "
    <script>
      ".d3_state_heatmap_legend_labels_function($sid, $options)."
      ".d3_state_heatmap_add_gradient($sid, $options)."
      ".viz_d3_state_heatmap_js_comma_separate()."
      ".viz_d3_state_heatmap_js_click_heatmap($sid, $options)."
      ".viz_d3_state_heatmap_js_reload($sid, $options)."
      ".viz_d3_state_heatmap_js_mark($sid)."
      ".viz_d3_state_heatmap_js_init_vars($sid)."
      ".viz_d3_state_heatmap_js_reload_update($sid)."
      ".viz_d3_state_heatmap_js_draw_heatmap($sid, $options)."
      ".viz_d3_state_heatmap_js_add_label($sid, $options)."
    </script>
  ";
}

function viz_d3_state_heatmap_js_reload($sid, $options){
  //General Options

  return "
    function reload".$sid."(dashboard, response){
      var element = document.getElementById('element$sid-container');
      element.classList.remove('loading');
    }
  ";
}

function viz_d3_state_heatmap_js_reload_update($sid){
  return "
...
function viz_d3_state_heatmap_js_mark($sid){
  return "
    function mark".$sid."(dashboard, response){
      var element = document.getElementById('element$sid-container');
      element.classList.add('loading');
      place_viz(dashboard, $sid, {'onUpdate': function(response,xmlhttp){reload".$sid."(response)}});
    }
  ";
}

function db_test_temp(){
  global $db;
  ...
  $scenario_db_name = $scenario_lookup[2];

  for($type = 1; $type < 4; $type ++) {
    if($state == 52) {
      # National View - Top 5 states graphs for GDP, Jobs and Exports
      $sql = 'insert into '.$tables[$type + 3].' select name,'.$scenario_db_name.' from (select state_id, '.$scenario_db_name.' from ttipall where type_id='.$type.' and sector_id='.$sector.' and state_id < 52 order by '.$scenario_db_name.' desc limit 5) p INNER JOIN states t on t.id = p.state_id';
      #var_dump($sql);
      $db->fetchAll($sql);
    }
    else if($state < 52) {
      # State View - Top 5 sector graphs for GDP, Jobs and Exports
      $sql = 'insert into '.$tables[$type + 3].' select sector,'.$scenario_db_name.' from (select sector_id, '.$scenario_db_name.' from ttipall where state_id='.$state.' and type_id='.$type.' and sector_id < 21 order by '.$scenario_db_name.' desc limit 5) p INNER JOIN sectors t on t.id = p.sector_id';
      $db->fetchAll($sql);
    }
    ...
    $sql = 'insert into outcomes_text select val_today, fut_nottip, '.$scenario_db_name.', type_id, '.$scenario_db_name.'_per, '.$scenario_db_name.'_tot from state_summaries where type_id='.$type.' and state_id='.$state;
      var_dump($sql);
    $db->fetchAll($sql);

    # Populate the values tables for the state heat map to use
    $sql = 'insert into '.$tables[$type - 1].' select state_id, '.$scenario_db_name_per.' from state_summaries where type_id='.$type.' and state_id<52';
    $db->fetchAll($sql);
  }
...
function d3_state_heatmap_add_gradient($sid, $options){
  $dashboard_options = $options["dashboard_options"];
  $min_color = "#".$dashboard_options["minColor"];
  $max_color = "#".$dashboard_options["maxColor"];
  $height = str_replace("px", "", $dashboard_options["height"]);

  return "
  function legend".$sid."gradient(){
    var svg".$sid."width = 100,
	svg".$sid."height = ".$height.",
	legend".$sid."height = ".max(array(100, $height - 50)).",
	legend".$sid."width = 25;

    var legend".$sid."svg = d3.select('#element$sid-legend-svg')
	.attr('width', svg".$sid."width)
	.attr('height', svg".$sid."height)
	.attr('id', 'legend".$sid."svg');

    var legend".$sid."gradient = legend".$sid."svg.append('svg:defs')
      .append('svg:linearGradient')
	.attr('id', 'legend".$sid."gradient')
	.attr('x1', '0%')
	.attr('y1', '0%')
	.attr('x2', '0%')
	.attr('y2', '100%')
    ...
    legend".$sid."gradient.append('svg:stop')
      .attr('offset', '0%')
    ...
    legend".$sid."group.append('svg:rect')
      ...
      .style('fill', 'url(#legend".$sid."gradient)');
  }
  ";
}

function d3_state_heatmap_legend_labels_function($sid, $options){
  //Dashboard Options
  $do = $options["dashboard_options"];
  $num_steps = $do["numSteps"];
  $label_color = "#".$do["legendLabelColor"];
  $label_weight = $do["legendLabelFontWeight"];
  $font_size = str_replace("px", "", $do["legendLabelFontSize"]);
  $width = str_replace("px", "", $do["width"]);

  return "
    function legend".$sid."labels(){
      var max = Math.max.apply(null,
	Object.keys(stateMetrics$sid).map(function(e) {
	  return stateMetrics".$sid."[e];
      }));
      ...
      var test = document.getElementsByClassName('legend$sid-text'),
	maxIdx = test.length;
	...
	$(test[0]).remove();
      ...
      var legendGroup = d3.select('#element".$sid."-legend-group'),
	legendSvg = d3.select('#element".$sid."-legend-svg'),
	...
	width = parseInt(d3.select('#legend".$sid."rect').attr('width'));
      ...
      var numSteps = ".$num_steps.", step;

      if(max < 1){
	step = diff/numSteps;
      }
      else{
	step = Math.round(diff/numSteps);
      }
	...
	var text = legendGroup.append('text')	
	  ...
	  .attr('font', 'Verdana')
	  .attr('class', 'legend$sid-text')
	  .attr('y', textY);

	if(i == numSteps){
	  if(max < 1){
	   value = Math.round(10000 * max)/10000;
	  }
	  else{
	    value = max;
	  }
	  ...
	  if(max < 1){
	    value = Math.round(Math.max(min + step * i, min) * 10000)/10000;
	  }
	  else{
	    value = Math.max(Math.round(min + step * i), min);
	  }
	}

	var labelText = commaSeparateNumber(value);
	...
	text.attr('x', parseInt(width + 5)); 
	text.attr('y', parseInt(text.attr('y')) + textHeight/4); 

	maxTextWidth = Math.max(textWidth, maxTextWidth);
      }

      d3.select('#legend".$sid."svg').attr('width', maxTextWidth + width + 5);
      document.getElementById('element$sid-container').style.width = Math.ceil(maxTextWidth + width + 10) + ".$width.";
    }
  ";
}

function js_state_metrics($state_metrics)
{
	$ret_val = "";

	for($i = 0; $i < count($state_metrics); $i++){
		$data = $state_metrics[$i];
		$ret_val .= "".$data["id"].":".$data["value"];

		if($i < count($state_metrics) - 1){
			$ret_val .= ",";
		}
	}
...
function viz_d3_state_heatmap_js_draw_heatmap($sid, $options)
{
  //Dashboard Options
  $do = $options["dashboard_options"];
  $min_color = "#".$do["minColor"];
  $max_color = "#".$do["maxColor"];
  
  return "
    function drawHeatmap$sid(){

      var svg = d3.select('#element$sid-svg');
      svg.html('');
	...
	.append('g')
	.attr('id', 'element$sid-states');

      var heatmap = d3.scale.linear()
	.domain(d3.extent(json$sid.features.map(function (d) { 
	    var val = stateMetrics".$sid."[d.id],
		logVal = 0;
	    
	    if(val < 0){
	      logVal = -1 * Math.log(Math.abs(val));
	    }
	    else if (val > 0){
	      logVal = Math.log(val);
	    }
	...
	.range(['$min_color', '$max_color']);
      ...
      var states = g$sid.selectAll('path')
	.data(json$sid.features)
	.enter().append('path')
	.attr('d', path$sid)
	.attr('id', function (d) { return d.properties.abbr.toUpperCase(); })
	.style('fill', function (d) {
	  ...
	  return heatmap(logVal); 
	})
	.on('click', clickHeatmap$sid)

      var labels = g$sid.selectAll('text')
	.data(json$sid.features)
	.enter().append('text')
	.attr('transform', function (d) { return 'translate(' + path$sid.centroid(d) + ')'; })
	.attr('id', function (d) { return 'label-' + d.properties.abbr.toUpperCase(); })
	.attr('dy', '.35em')
	.on('click', clickHeatmap$sid)
...
function viz_d3_state_heatmap_js_click_heatmap($sid, $options)
{
  return "
    function clickHeatmap$sid(d){
      if(d == null){
	return;
      }
      g$sid.selectAll('path').classed('temp', function(x){
	var xid = x.properties.abbr.toUpperCase();

	if(xid == d.id || (d.properties != null && xid == d.properties.abbr.toUpperCase())){
	  d = x;

	  if(d != currentlySelectedState$sid){
	    centered$sid = null;
	    currentlySelectedState$sid = d;
	  }
	...
	centered$sid = currentlySelectedState$sid;
	fromReload$sid = false;
      }
      ...
      if (centered$sid == null || fromReload$sid) {
	var centroid = path$sid.centroid(d);
	x = -centroid[0];
	y = -centroid[1];
	k = 4;
	centered$sid = d;
	...
	centered$sid = null;
	currentlySelectedState$sid = null;
      }

      g$sid.selectAll('path')
	.classed('active', centered$sid && function (d) { return d === centered$sid || ( fromReload$sid && d.properties.abbr.toUpperCase() == centered$sid.properties.abbr.toUpperCase()); });
      g$sid.selectAll('text')
	.text(function (d) { return d.properties.abbr.toUpperCase(); })
	.classed('active', function (d) { return d === centered$sid || ( fromReload$sid && d.properties.abbr.toUpperCase() == centered$sid.properties.abbr.toUpperCase()); });
      if (centered$sid) {
	g$sid.select('#label-' + centered$sid.properties.abbr.toUpperCase())
	  .text(function (d) { element".$sid."addLegendLabel(d); return d.properties.name + ': ' + (commaSeparateNumber(stateMetrics".$sid."[parseInt(d.id, 10)]) || '(none)'); })
	  .classed('active', function (d) { return d === centered$sid || ( fromReload$sid && d.properties.abbr.toUpperCase() == centered$sid.properties.abbr.toUpperCase()); });
      }
      else{
	d3.select('#element".$sid."selectedStateLabel').remove();
      }
...
function viz_d3_state_heatmap_js_add_label($sid, $options)
{
  //Dashboard Options
  $do = $options["dashboard_options"];
  $label_color = "#".$do["selectedStateLegendLabelColor"];
  $font_size = str_replace("px", "", $do["legendLabelFontSize"]);

  return "
    function element".$sid."addLegendLabel(d){
      var max = Math.max.apply(null,
	Object.keys(stateMetrics$sid).map(function(e) {
	  return stateMetrics".$sid."[e];
	}));
	...
	width = parseInt(d3.select('#legend".$sid."rect').attr('width'));
      ...
      var percentage = (stateMetrics".$sid."[parseInt(d.id, 10)] - min)/diff * 100,
	textY = yOffset + (height - (height * percentage/100));
	...
	.attr('font', 'Verdana')
	.attr('y', textY)
	.attr('id', 'element".$sid."selectedStateLabel');
...
function viz_d3_state_heatmap_add_styles($sid, $options){
  //Options

  //Dashboard Options
  $do = $options["dashboard_options"];

  $select_color = "#".$do["selectcolor"];

  $height = str_replace("px", "", $do["height"]);
  $width = str_replace("px", "", $do["width"]);
  $x = str_replace("px", "", $do["x"]);
  $y = str_replace("px", "", $do["y"]);

  $hl_thickness = str_replace("px", "", $do["loadingHighlightThickness"]);
  ...
  $active_font_size = str_replace('px', '', strtolower($do["activeStateFontSize"]));
  $active_font_weight = $do["activeStateFontWeight"];
  $active_font_color = "#".$do["activeStateTextColor"];
  $active_font_outline_width = $do["activeStateFontOutlineWidth"];
  $active_font_outline_color = "#".$do["activeStateFontOutlineColor"];

  $state_outline_width = $do["stateOutlineWidth"];
  $state_outline_color = "#".$do["stateOutlineColor"];

  $label_font_size = str_replace('px', '', strtolower($do["stateLabelFontSize"]));
  $label_font_color = "#".$do["stateLabelTextColor"];

  $state_label_font = $do["stateLabelFontName"];
  ...
  return "
	...
	text-align: $title_horizontal_alignment;
      ...
      #element$sid-container{
	position: absolute;
	height: ".($height + 4)."px;
	width: ".($width + 100 + 4)."px;
	border: ".$hl_thickness."px solid transparent;
      }

      #element$sid-container.loading{
	...
	pointer-events: all;
      ...
      #element$sid-legend-div{
	float: right;
      }

      #element$sid-states {
	stroke: $state_outline_color;
	stroke-width: ".$state_outline_width."px;
      }

      #element$sid-states text {
	...
	font-size: ".$label_font_size."px;
      ...
      #element$sid-states .active {
	fill: $select_color !important;
      }

      #element$sid-states text.active {
	font-size: ".$active_font_size."px;
	font-weight: $active_font_weight;
	stroke-width: ".$active_font_outline_width."px;
	fill: $active_font_color !important;
	stroke: $active_font_outline_color;
      }
    </style>
...
function viz_d3_state_heatmap_js_comma_separate(){
  return "
    function commaSeparateNumber(val){
      var valueParts = val.toString().split('.'),
	  first = Math.abs(parseInt(valueParts[0])),
	  second = valueParts[1];

      while (/(\d+)(\d{3})/.test(first.toString())){
	first = first.toString().replace(/(\d+)(\d{3})/, '$1'+','+'$2');
      }
...
function viz_d3_state_heatmap_js_states_json(){
  return "
    {
