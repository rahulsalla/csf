<?
function getsetup_viz_d3_barchart_unusual_exp()
{
...
function place_viz_d3_barchart_unusual_exp($sid, $value, $options, $setup)
{
	...
	$content = reload_viz_d3_barchart_unusual_exp($sid,$value,$options,$setup);
...
<script type="text/javascript">
    ...
    function grouped_d3_barchart_unusual_exp'.$sid.'(labels, data, redraw)
    {
...
//Change needed here
    ...
    function stacked_d3_barchart_unusual_exp'.$sid.'(labels,data,redraw)
    {
    ...
    function draw_d3_barchart_unusual_exp'.$sid.'(legendLabels,data,redraw)
    {
        if ('.$dashboard_options['isStacked'].') 
            stacked_d3_barchart_unusual_exp'.$sid.'(legendLabels,data,redraw);
        else 
            grouped_d3_barchart_unusual_exp'.$sid.'(legendLabels,data,redraw);
    }

    '.$content.'
    draw_d3_barchart_unusual_exp'.$sid.'(legendLabels'.$sid.',data'.$sid.');
</script>';	
	...
	$str.= '<script language="JavaScript" type="text/javascript">
				...
				function reload_update'.$sid.'(response)
				{
					...
					draw_d3_barchart_unusual_exp'.$sid.'(legendLabels'.$sid.',data'.$sid.',redraw);
...
function reload_viz_d3_barchart_unusual_exp($sid, $value, $options, $setup)
{
	global $db;
