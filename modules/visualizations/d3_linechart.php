<?
function getsetup_viz_d3_LineChart()
{
...
function place_viz_d3_LineChart($sid, $value, $options, $setup)
{
    ...
    $content = reload_viz_d3_linechart($sid,$value,$options,$setup);
...
<script type="text/javascript">
    ...
    function draw_d3_linechart'.$sid.'(labels, data,redraw)
    {
...
//Change here from Legend Name to Legend Label if you wan tthe column names as the legend values
	...
	//	d3.select(this).on("click",function(d){window.alert(d.id)})
		;})
...
//Change here from Legend Name to Legend Label if you want the column names as the legend values
    ...
    '.$content.'
    draw_d3_linechart'.$sid.'(legendLabels'.$sid.',data'.$sid.');
</script>';
	...
	$str.= '	<script language="JavaScript" type="text/javascript">
				...
				function reload_update'.$sid.'(response)
				{
                    ...
                    draw_d3_linechart'.$sid.'(legendLabels'.$sid.',data'.$sid.',redraw);
...
function reload_viz_d3_LineChart($sid, $value, $options, $setup)
{
	global $db;
