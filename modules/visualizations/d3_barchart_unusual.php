<?
function getsetup_viz_d3_barchart_unusual()
{
...
function place_viz_d3_barchart_unusual($sid, $value, $options, $setup)
{
	...
	$content = reload_viz_d3_barchart_unusual($sid,$value,$options,$setup);
...
<script type="text/javascript">
    ...
    function grouped_d3_barchart_unusual'.$sid.'(labels, data, redraw)
    {
...
//Change needed here
    ...
    function stacked_d3_barchart_unusual'.$sid.'(labels,data,redraw)
    {
...
//                .attr("fill","#'.$dashboard_options['vAxisColor'].'")
    ...
    function draw_d3_barchart_unusual'.$sid.'(legendLabels,data,redraw)
    {
        if ('.$dashboard_options['isStacked'].') 
            stacked_d3_barchart_unusual'.$sid.'(legendLabels,data,redraw);
        else 
            grouped_d3_barchart_unusual'.$sid.'(legendLabels,data,redraw);
    }

    '.$content.'
    draw_d3_barchart_unusual'.$sid.'(legendLabels'.$sid.',data'.$sid.');
</script>';	
	...
	$str.= '<script language="JavaScript" type="text/javascript">
				...
				function reload_update'.$sid.'(response)
				{
					...
					draw_d3_barchart_unusual'.$sid.'(legendLabels'.$sid.',data'.$sid.',redraw);
...
function reload_viz_d3_barchart_unusual($sid, $value, $options, $setup)
{
	global $db;
