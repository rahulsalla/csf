<?
function getsetup_viz_d3_barchart_unusual_test()
{
...
function place_viz_d3_barchart_unusual_test($sid, $value, $options, $setup)
{
	...
	$content = reload_viz_d3_barchart_unusual_test($sid,$value,$options,$setup);
...
<script type="text/javascript">
    ...
    function grouped_d3_barchart_unusual_test'.$sid.'(labels, data, redraw)
    {
...
//Change needed here
		...
		//Translate over the Y axis, changed from -800 to -685
            .attr("transform", function(d, i) { return "rotate(90)translate(160,-185)"; })
    ...
    function stacked_d3_barchart_unusual_test'.$sid.'(labels,data,redraw)
    {
...
//                .attr("fill","#'.$dashboard_options['vAxisColor'].'")
    ...
    function draw_d3_barchart_unusual_test'.$sid.'(legendLabels,data,redraw)
    {
        if ('.$dashboard_options['isStacked'].') 
            stacked_d3_barchart_unusual_test'.$sid.'(legendLabels,data,redraw);
        else 
            grouped_d3_barchart_unusual_test'.$sid.'(legendLabels,data,redraw);
    }

    '.$content.'
    draw_d3_barchart_unusual_test'.$sid.'(legendLabels'.$sid.',data'.$sid.');
</script>';	
	...
	$str.= '<script language="JavaScript" type="text/javascript">
				...
				function reload_update'.$sid.'(response)
				{
					...
					draw_d3_barchart_unusual_test'.$sid.'(legendLabels'.$sid.',data'.$sid.',redraw);
...
function reload_viz_d3_barchart_unusual_test($sid, $value, $options, $setup)
{
	global $db;
