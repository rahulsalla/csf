<?
function getsetup_viz_d3_Calendar()
{
	$options['_CREDITS']				= 'Main Developer: Jie Fang';
			$options['_MODULEDESCRIPTION']		= '<p>Each row in the table represents a date with a event number</p>    <p>Columns:</p>        <ul>
        <li>Column 0: date </li>
...
function place_viz_d3_Calendar($sid, $value, $options, $setup)
{
	...
	$content = reload_viz_d3_Calendar($sid,$value,$options,$setup);
...
<script>
function draw_d3_calendar'.$sid.'(data,labels){
...
'.$content.'
draw_d3_calendar'.$sid.'(data'.$sid.',labels'.$sid.');
</script>';
...
function reload_viz_d3_Calendar($sid, $value, $options, $setup)
{
	global $db;
