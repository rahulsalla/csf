...
#	fwrite($handle, $data);
#	fclose($handle);
	if(!file_exists("/home/tmp/tmp_".session_id())) mkdir("/home/tmp/tmp_".session_id());
        $_FILES["Filedata"]["name"]=str_replace(' ','_',$_FILES["Filedata"]["name"]);
	if(file_exists("/home/tmp/tmp_".session_id()."/".$_FILES["Filedata"]["name"])) unlink("/home/tmp/tmp_".session_id()."/".$_FILES["Filedata"]["name"]);
	
	rename($_FILES["Filedata"]["tmp_name"],"/home/tmp/tmp_".session_id()."/".$_FILES["Filedata"]["name"]);
