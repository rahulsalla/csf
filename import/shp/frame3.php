...
if(isset($_GET["id"]))
{
	$_SESSION['tbl']=strtolower(basename($shapefiles[$_GET["id"]]["shp"],".shp"));

	echo ' Insert Shapefile: '.$shapefiles[$_GET["id"]]["shp"].'<br><br>';

	echo '
		<form action="load.php" method="POST" enctype="multipart/form-data">
		<table name="ta" id="ta">
		<tr><td>Table:</td><td><input name="tbl" type="text" size="35" maxlength="150" value="'.$_SESSION['tbl'].'"></td></tr>
		</tr>
		</table>
